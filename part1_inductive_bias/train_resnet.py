...
def build_scheduler(optimizer, args):
    ...
    # Warmup + cosine decay helps stabilize early training and improve final accuracy.
...
def main():
    ...
    run_name = f"resnet18_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
    ...
    ckpt_path = os.path.join(args.save_dir, "resnet_last.pth")
